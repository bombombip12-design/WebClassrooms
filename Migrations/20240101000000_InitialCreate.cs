...
namespace FinalASB.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SystemRoleId = table.Column<int>(type: "int", nullable: false, defaultValue: 2),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriveFileId = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    DriveFileUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
        ...
        {
            migrationBuilder.DropTable(name: "AnnouncementFiles");
            migrationBuilder.DropTable(name: "AssignmentFiles");
            migrationBuilder.DropTable(name: "Comments");
            migrationBuilder.DropTable(name: "SubmissionFiles");
